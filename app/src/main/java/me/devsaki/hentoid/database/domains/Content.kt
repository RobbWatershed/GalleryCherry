...
data class Content(
    ...
    private fun computeUniqueSiteId(): String {
        ...
        when (site) {
            ...
            Site.PORNPICS, Site.HELLPORNO, Site.PORNPICGALLERIES, Site.LINK2GALLERIES, Site.NEXTPICTUREZ, Site.JJGIRLS2, Site.SXYPIX, Site.PICS_X, Site.BABETODAY, Site.BESTGIRLSEXY, Site.XIUTAKU, Site.KIUTAKU, Site.XINMEI, Site.V2PH, Site.EVERIA, Site.FAPELLO -> return parts[parts.size - 1]
    ...
    val galleryUrl: String
        get() {
            val galleryConst = when (site) {
                ...
                Site.HELLPORNO, Site.FAPALITY, Site.ASIANSISTER, Site.FOAMGIRL, Site.XIUTAKU, Site.KIUTAKU, Site.XINMEI, Site.V2PH, Site.EVERIA, Site.FAPELLO -> ""
