...
import me.devsaki.hentoid.activities.sources.EveriaActivity
import me.devsaki.hentoid.activities.sources.FapalityActivity
import me.devsaki.hentoid.activities.sources.FapelloActivity
import me.devsaki.hentoid.activities.sources.FoamGirlActivity
import me.devsaki.hentoid.activities.sources.GalleryEpicActivity
...
import me.devsaki.hentoid.activities.sources.KiutakuActivity
...
import me.devsaki.hentoid.activities.sources.V2PhActivity
...
data class Content(
    ...
    companion object {
        fun getWebActivityClass(site: Site): Class<out AppCompatActivity> {
            return when (site) {
                ...
                Site.V2PH -> V2PhActivity::class.java
    ...
    private fun computeUniqueSiteId(): String {
        ...
        when (site) {
            ...
            Site.PORNPICS, Site.HELLPORNO, Site.PORNPICGALLERIES, Site.LINK2GALLERIES, Site.NEXTPICTUREZ, Site.JJGIRLS2, Site.SXYPIX, Site.PICS_X, Site.BABETODAY, Site.BESTGIRLSEXY, Site.XIUTAKU, Site.KIUTAKU, Site.XINMEI, Site.V2PH, Site.EVERIA, Site.FAPELLO, Site.GALLERYEPIC -> return parts[parts.size - 1]
    ...
    val galleryUrl: String
        get() {
            val galleryConst = when (site) {
                ...
                Site.HELLPORNO, Site.FAPALITY, Site.ASIANSISTER, Site.FOAMGIRL, Site.XIUTAKU, Site.KIUTAKU, Site.XINMEI, Site.V2PH, Site.EVERIA, Site.FAPELLO, Site.GALLERYEPIC -> ""
