...
import me.devsaki.hentoid.databinding.FragmentBrowserBookmarksBinding
...
class BookmarksDrawerFragment : Fragment(R.layout.fragment_browser_bookmarks),
    ItemTouchCallback,
    ...
    override fun onCreateView(
        ...
        binding = FragmentBrowserBookmarksBinding.inflate(inflater, container, false)
        return binding?.root
    }
