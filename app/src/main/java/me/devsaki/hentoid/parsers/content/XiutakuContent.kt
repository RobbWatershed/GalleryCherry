...
class XiutakuContent : BaseContentParser() {
    ...
    override fun update(content: Content, url: String, updateImages: Boolean): Content {
        content.site = Site.XIUTAKU

        content.url = url.replace(Site.XIUTAKU.url, "")
        content.title = title ?: NO_TITLE

        val attributes = AttributeMap()

        parseAttributes(attributes, AttributeType.MODEL, models, false, Site.XIUTAKU)
        parseAttributes(attributes, AttributeType.TAG, tags, false, Site.XIUTAKU)
