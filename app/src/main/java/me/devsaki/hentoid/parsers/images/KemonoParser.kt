...
class KemonoParser : BaseImageListParser() {
    ...
    companion object {
        ...
        fun parseGallery(
            ...
            return Content(site = Site.COOMER, status = StatusContent.IGNORED)
        }
                ...
                content.addAttributes(
                    listOf(
                        Attribute(
                            ...
                            artist.name,
                            "https://$COOMER_DOMAIN_FILTER/${artist.service}/user/${artist.id}",
                            Site.COOMER
                        )
                    )
                )
